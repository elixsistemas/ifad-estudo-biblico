...
export default function PedidoOracao(){
  ...
  function onSubmit(e){
    ...
    if(!nome || pedido.length<10){ e.preventDefault(); setErro("Nome e pedido (mínimo 10 caracteres) são obrigatórios."); }
  }
  return (
    <>
      <SiteHeader />
      <main className="container">
        ...
        <form name="pedido-oracao" method="POST" data-netlify="true" netlify-honeypot="bot-field" onSubmit={onSubmit} className="form">
